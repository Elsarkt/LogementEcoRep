...
def remplissage() :
    ...
    def adapt_datetime(ts): #chatgpt : écris une fonction qui permet de fournir un format de date correct pour sqlite
    ...
    for i in range(50): 
        # idCapteur_i = random.randint(1,4) #le capteur est un des quatres initialisés
        type_fact_i = random.randint(1,4) #type de facture: elec...
